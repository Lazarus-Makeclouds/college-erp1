...
?>
<ul>
    <a  style="text-decoration: none; color:blue" href="dashboard.php?src=overall">View OverAll Marks</a>
...
<body>
    ...
    <form id="marksForm" action="./dashboard.php?src=displaymark" method="POST">
