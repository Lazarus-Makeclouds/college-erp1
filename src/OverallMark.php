...
?>
<ul>
    <a  style="text-decoration: none; color:blue" href="dashboard.php?src=OverallMark">View OverAll Marks</a>
...
<body>
    ...
    <form id="marksForm" action="./dashboard.php?src=addoveralluniversity" method="POST">
