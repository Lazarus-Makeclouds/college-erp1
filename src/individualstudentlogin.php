...
if (Input::exists("get")):
    ...
    Redirect::to("./admin.php?admin=managesinglestudent");
endif;
?>
<style>
    .profileimage {
...
<ul>
    ...
    <?php if (isset($_GET['id'])): ?>
        > <a style="text-decoration: none; color:blue" href="dashboard.php?src=individualstudentlogin&id=<?= $_GET['id']; ?>">Student Profile</a>
    <?php endif; ?>
    <?php if (isset($_GET['sem'])): ?>
        > <a style="text-decoration: none; color:black" href="hp-works/dashboard.php?src=markstudentlogin&sem=<?= $_GET['sem']; ?>&id=<?= $_GET['id']; ?>">Marks - Semester <?= $_GET['sem']; ?></a>
    <?php endif; ?>
</ul>
<body>
    <section>
...
<script>
    function openMarksPage(id, semester) {
        if (semester) {
            ...
            var url = `./dashboard.php?src=individualstudentmark&sem=${semester}&id=${id}&timestamp=${timestamp}`;
