...
?>
 <ul>
    <a  style="text-decoration: none; color:blue" href="dashboard.php?src=adduniversitymark">Add Semester Marks</a>
    
        > <a style="text-decoration: none; color:blue" href="dashboard.php?src="></a> 
</ul>
<body>
    <h1 style="text-align: center;"> Student Semester Marks </h1>

    <form id="marksForm" action="./dashboard.php?src=addmarks" method="POST">
...
<script>
    ...
    async function fetchSem() {
        ...
        for (let j = 1; j <= i; j++) {
            var option = document.createElement("option");
            option.text = j; // The text shown in the dropdown
            option.value = j; // The value sent when the option is selected
