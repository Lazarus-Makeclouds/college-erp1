...
?>
<ul>
    <a style="text-decoration: none; color:black" href="dashboard.php?src=addinternalmark">Add InternalMark</a>
    > <a style="text-decoration: none; color:blue" href="dashboard.php?src=#">Add Student InternalMark</a>
</ul>
<table>
    <thead>
        <tr>
