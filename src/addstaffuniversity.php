...
if (Input::exists("post")):
    ...
    // Fetch staff allocation details based on year, department, and semester
    ...
    // Create an associative array to store staff details by subject
    $staffDetails = [];
    foreach ($staffAllocationResults as $staff) {
        $staffDetails[$staff->subject] = [
            'staffName' => $staff->staffName,
            'department' => $staff->subjectDept,
...
<table>
    ...
    <tbody id="studentMarks">
        ...
        <?php foreach ($subject_stats as $subject_name => $stats): ?>
            <tr>
                <td><?= escape($staffDetails[$subject_name]['staffName'] ?? 'N/A'); ?></td>
                <td><?= escape($staffDetails[$subject_name]['department'] ?? 'N/A'); ?></td>
