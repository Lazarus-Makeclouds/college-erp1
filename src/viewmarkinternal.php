...
<ul>
    <a  style="text-decoration: none; color:black" href="dashboard.php?src=viewinternalmark">View Internal Marks</a>
        ...
        > <a style="text-decoration: none; color:blue" href="dashboard.php?src=viewmarkinternal">View & Edit InternalMark</a> 
</ul>
    <table>
        <thead>
            <tr>
            ...
            <?php if (empty($results)): ?>
                ...
                ?>
                    <tr>
                        ...
                        <td><?= escape($mark); ?></td>
                        <td>
                            <form method="post" action="backend/editMarks.php" id="editMarks<?= $i ?>">
