...
?>
<ul>
    <a  style="text-decoration: none; color:blue" href="dashboard.php?src=viewinternalmark">View Internal Marks</a>
    
        > <a style="text-decoration: none; color:black" href="dashboard.php?src=addmarkinternal"></a> 
</ul>
<body>
    <h1 style="text-align: center;"> View Internal Marks </h1>

    <form id="marksForm" action="./dashboard.php?src=viewmarkinternal" method="POST">
