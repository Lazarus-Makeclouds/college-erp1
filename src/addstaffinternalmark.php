...
?>
<ul>
    <a  style="text-decoration: none; color:blue" href="dashboard.php?src=addstaffinternalmark">Add InternalMark</a>
...
<body>
    ...
    <form id="marksForm" action="./dashboard.php?src=addingmarkstaff" method="POST">
