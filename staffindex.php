...
<div class="flex flex-col justify-center items-center min-h-screen bg-gradient-to-br from-gray-50 via-gray-200 to-gray-300">
    <div id="teacherslogin" class="w-full max-w-lg px-4">
        <form 
            action="" 
            method="post" 
        ...
        >
            <div class="text-center mb-8">
                <i class="fa-solid fa-chalkboard-user text-6xl text-orange-500 mb-4 transition-transform duration-300 ease-in-out hover:rotate-12"></i>
