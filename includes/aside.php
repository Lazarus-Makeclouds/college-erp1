...
<body>
                    ...
                    <ul>
                        ...
                        <?php else: ?>
                            <?php foreach ($notifications as $notification): ?>
                                <li><?php echo htmlspecialchars($notification->Notification); ?>
                                    <span class="text-xs text-gray-500"><?php echo date("h:i A", strtotime($notification->CreatedDate)); ?></span>
                                </li>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </ul>
    ...
    <div class="container">
        ...
        <div class="sidebar">
            ...
            <a href="./dashboard.php?src=addexcel"
                    style="<?php echo $current_page === 'addexcel' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                    Import Excel File
                </a>
                ...
                <a href="./dashboard.php?src=subjectallocation"
                    style="<?php echo $current_page === 'subjectallocation' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                    Subject Allocation For Staff
                </a>
                <a href="./dashboard.php?src=managesubjectallocation"
                    style="<?php echo $current_page === 'managesubjectallocation' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                    Manage Allocation For Staff
                </a>
            ...
            <a href="./dashboard.php?src=Overall"
                ...
                <a href="./dashboard.php?src=displayoverall"
                    style="<?php echo $current_page === 'displayoverall' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                    Staff Overall
                </a>
            ...
            <a href="./dashboard.php?src=OverallMark"
                ...
                <a href="./dashboard.php?src=staffuniversityoverall"
                    style="<?php echo $current_page === 'staffuniversityoverall' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                    StaffOverallMark
                </a>
            ...
            <a href="./dashboard.php?src=viewattendance"
                ...
                $allowed_pages = [
                    ...
                    'managestudents',
                    'allstudentsprofiles',
                    'individualstafflogin',
                    'individualstaff',
                    'addnewquestion',
                    'managequestion',
                    'uploadtimetable',
                    'viewtimetable',
                    'addstaffinternalmark',
                    'viewmarkstaff',
                    'overall',
                    'marks',
                    'addmarks',
                    ...
                    'adduniversitymark',
                    'viewuniversitymark',
                    'addoveralluniversity',
                    'viewstaffmark',
                    'OverallMark',
                    'addstaffMarkinternal',
                    'subjectallotlogin',
                    'addattendance',
                    'addingmarkstaff',
                    'viewattendance',
        ...
        <h2>Students Profile Management</h2>
            ...
            <h2>Staff Profile Management</h2>
            <a href="./dashboard.php?src=individualstafflogin"
                    style="<?php echo $current_page === 'individualstafflogin' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                    Manage Staff
                </a>
                <h2>Allocated Subjects</h2>
            <a href="./dashboard.php?src=subjectallotlogin"
                    style="<?php echo $current_page === 'subjectallotlogin' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                    Subject Allocated
                </a>
            ...
            <h2>Internal Mark Management</h2>
            <a href="./dashboard.php?src=addstaffinternalmark"
                style="<?php echo $current_page === 'addstaffinternalmark' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                Add New Marks
            </a>
            <a href="./dashboard.php?src=viewinternalmark"
                style="<?php echo $current_page === 'viewinternalmark' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
            ...
            <a href="./dashboard.php?src=overall"
                ...
                <a href="./dashboard.php?src=staffoverall1"
                    style="<?php echo $current_page === 'staffoverall1' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                    Staff Overall
                </a>
            <h2>University Mark Management</h2>
        ...
        <?php endif; ?>
            ...
            $allowed_pages = [
                'index',
                'managesinglestudent',
                'studentloginquestion',
                'timetablestudentlogin',
                'individualstudentlogin',
                'viewparticularstdattendance',
                'marks',
                'attendancestudent',
                'yearwise',
                'yearwiseattendance',
                'individualstudentmark'
            ];
            $current_page = $_GET['src'] ?? '';
        ...
        ?>
            ...
            <a href="./dashboard.php?src=managesinglestudent"
                style="<?php echo $current_page === 'managesinglestudent' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                Manage Student Details
            </a>
            <a href="./dashboard.php?src=studentloginquestion"
                style="<?php echo $current_page === 'studentloginquestion' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                Manage Questions
            </a>
            <a href="./dashboard.php?src=timetablestudentlogin"
                style="<?php echo $current_page === 'timetablestudentlogin.php' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                Manage New Timetable
            </a>
            <a href="./dashboard.php?src=viewparticularstdattendance"
                style="<?php echo $current_page === 'viewparticularstdattendance' ? 'background-color: #3498db; color: white; font-weight: bold;' : ''; ?>">
                Manage Update
            </a>
